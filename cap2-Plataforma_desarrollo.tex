...
\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{figura/sensor/ecg/ecg.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.7]{figura/sensor/t/lilypad.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.2]{figura/sensor/t/ds18.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{figura/tela/medtex.jpg}
...
\section{Unidad de movimiento inercial (IMU)}
...
\begin{figure}[H]
\centering
\includegraphics[scale=1.5]{figura/sensor/imu/imu1.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{figura/sensor/imu/imu11.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.8]{figura/com/gprs.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{figura/com/antena.jpg}
...
\subsection{Bluetooth BLE shield}
...
El shield Bluetooth posee un módulo RN4020 el cual ofrece una antena para la comunicación en su misma placa lo que facilita el diseño como se puede observar en la figura \ref{bt}.

\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{figura/com/rn4020.png}
